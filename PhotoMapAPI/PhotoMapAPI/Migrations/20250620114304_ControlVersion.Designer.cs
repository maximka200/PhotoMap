...
namespace PhotoMapAPI.Migrations
{
    ...
    [Migration("20250620114304_ControlVersion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhotoMapAPI.Models.Avatar", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PhotoUser", b =>
                {
                    ...
                    b.Property<long>("LikedPhotosUId")
                        .HasColumnType("bigint");

                    b.HasKey("LikedByUsersId", "LikedPhotosUId");

                    b.HasIndex("LikedPhotosUId");
            ...
            modelBuilder.Entity("PhotoMapAPI.Models.Avatar", b =>
                {
                    b.HasOne("User", "User")
                        .WithOne("UserAvatar")
                        .HasForeignKey("PhotoMapAPI.Models.Avatar", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
